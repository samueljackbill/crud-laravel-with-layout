    ...
    <div class="card mt-4 mb-4 border-light shadow">
        <div class="card-header hstack gap-2">
            ...
            <span class="ms-auto d-sm-flex flex-row">
                ...
                <a href="<?php echo e(route('user.show', ['user' => $user->id])); ?>" class="btn btn-primary btn-sm me-1">Visualizar</a>
            </span>
        </div>
...
<?php endif; ?>
            ...
            <form action="<?php echo e(route('user.update', ['user' => $user->id])); ?>" method="POST" class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nome completo" value="<?php echo e(old('nome', $user->name)); ?>">
                </div>

                <div class="col-md-12">
                    <label for="email" class="form-label">E-mail</label>
                    <input type="email" class="form-control" id="email" name="email" placeholder="Melhor e-mail do usuário" value="<?php echo e(old('email', $user->email)); ?>">
                </div>
